public class AirflowMagicModel : MagicModel
{
    ...
    protected override void ResolveCast(PlayerState playerState, BattleManager battleManager, MagicCastResult result) => DamageTarget(playerState, battleManager, 3, result);
}
