public class WaterCorrosionMagicModel : MagicModel
{
    ...
    protected override void ResolveCast(PlayerState playerState, BattleManager battleManager, MagicCastResult result) => AddBuff(Target(battleManager), BuffEnum.Weak, 1, result);
}
