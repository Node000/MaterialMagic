public class StoneWallMagicModel : MagicModel
{
    ...
    protected override void ResolveCast(PlayerState playerState, BattleManager battleManager, MagicCastResult result) => GainShield(playerState, battleManager, 2, result);
}
