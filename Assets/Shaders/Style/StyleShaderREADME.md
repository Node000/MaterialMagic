...
- `UI/Text_FloatAccent.shader`：S03，兼容当前项目的 legacy UI Text，提供描边、阴影、Glow、暴击 RGB 轻分离和闪白。
...
- Text：`M_Text_FloatAccent_Damage`、`M_Text_FloatAccent_Crit`、`M_Text_FloatAccent_Heal`、`M_Text_FloatAccent_Debuff`
